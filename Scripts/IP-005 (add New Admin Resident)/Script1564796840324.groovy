...
WebUI.setText(findTestObject('Page_iPropio - Admins/input_First Name_first name'), 'iprop3')

WebUI.check(findTestObject('Page_iPropio - Admins/input_Last  Family Name_last name'))

WebUI.setText(findTestObject('Page_iPropio - Admins/input_Last  Family Name_last name'), 'project otomasi3 resident')
...
WebUI.setText(findTestObject('Page_iPropio - Admins/input_Email_email'), 'junkmailist0908@gmail.com')
...
WebUI.click(findTestObject('Page_iPropio - Admins/li_Resident'))

WebUI.delay(5)

WebUI.takeScreenshot()

WebUI.click(findTestObject('Page_iPropio - Admins/input_Street Name_vs__search'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_iPropio - Admins/li_Jl Mentari Bersinar'))

WebUI.click(findTestObject('Page_iPropio - Admins/input_House Number_vs__search'))

WebUI.click(findTestObject('Page_iPropio - Admins/li_12'))
